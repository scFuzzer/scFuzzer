...
static void show_stats(void) {
  ...
  FILE *fp;
  fp = fopen("OutputInfo.txt", "w");
  char outputInfo[] = "OutputInfo: \n";
...
#define SP20    SP10 SP10
  ...
  strcat(outputInfo, DTD(cur_ms, start_time));
  strcat(outputInfo, "\n");
  strcat(outputInfo, DI(queue_cycle - 1));
  strcat(outputInfo, "\n");
  ...
  strcat(outputInfo, unique_crashes);
  strcat(outputInfo, "\n");
  ...
  fwrite(outputInfo, sizeof(outputInfo), 1, fp);
  fclose(fp);
